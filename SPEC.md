...
| **An unescaped quote inside a string can be reported as truncation.** It
leaves the scanner inside a string at the end of the text, which looks identical
to a response that stopped early, and the advice attached to that message, raise
